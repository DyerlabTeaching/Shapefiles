---
title: "In Class Activity - Shapefiles"
format: html
---
...
# This code will allow you to download the raw shapefiles used in this example.
#  Run it only ONCE—once you have the data downloaded, you do not need to grab it again.
...
8. Create a plot of the districts as the background, the target district (OBJECTID=368) as highlighted in another color, and the roads that cross the it overlay on top.
